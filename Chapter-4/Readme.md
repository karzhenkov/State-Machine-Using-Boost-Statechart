...
```
_The only difference between a normal state and the meta state is that the meta state takes also_ __Inner State__ _as 3nd template parameter. The statemachine code once started will be in in_ __firstState_Inner_1__.
